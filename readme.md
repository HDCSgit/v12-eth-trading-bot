...
### v12.6.5 (2026-03-27) 🎯 方案B1: EVT高目标止盈
- [x] **实现方案B1**: 超过1.6%后，EVT计算更高固定目标
- [x] **阶段1**: 盈利<1.6%时，强制目标≥1.6%
- [x] **阶段2**: 盈利≥1.6%时，目标=max(EVT, 1.6%×1.5) + 额外盈利的50%
- [x] 例: 当前2.5%，目标=2.4%+(2.5-1.6)%×0.5=2.85%，达到2.85%才止盈
