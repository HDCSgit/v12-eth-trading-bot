...
### v12.6.5 (2026-03-27) 🎯 方案B1修正: 锁定高目标
- [x] **修复"永远追不上"Bug**: 原逻辑目标随盈利动态增加，难以触发
- [x] **阶段1**: 盈利<1.6%，目标锁定1.6%
- [x] **阶段2**: 盈利≥1.6%，立即计算并**锁定**高目标
- [x] **高目标公式**: max(EVT原始, 2.4%, 当前盈利+0.3%)
- [x] 例: 盈利2.5%进入阶段2→锁定目标2.8%→达到2.8%止盈（目标不再变化）
