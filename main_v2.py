...
from strategy_v2 import ExpertStrategyV2  # 使用优化版策略
...
def setup_logging():
    ...
    trade_logger.addHandler(trade_handler)  # 确保trade日志也写入文件
    return trade_logger
...
class ProductionSystemV2:
    def __init__(self):
        ...
        self.strategy = ExpertStrategyV2()  # 使用V2策略
    ...
    def run(self):
        ...
        logger.info("💡 V2策略特点: 信号叠加 + 连续止损保护 + 追踪止盈")
            ...
            try:
                ...
                for symbol in CONFIG["SYMBOLS"]:
                    ...
                    signal = self.strategy.generate_signal(
                        symbol, df, current_pos, current_price, btc_df
                    )
